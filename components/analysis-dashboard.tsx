...
import { Brain, BookOpen, Target, Sparkles, ArrowRight, CheckCircle, Lightbulb, AlertCircle, ExternalLink, Calendar, RefreshCw, GraduationCap, FileText } from "lucide-react"
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    {/* <Button
                      size="lg"
                      className="bg-emerald-500 text-white hover:opacity-90 px-6 py-6"
                      onClick={() => (window.location.href = "/analizecv")}
                    >
